...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <h1 class="text-center mb-4">{{ app()->getLocale() == 'fr' ? $textosPiloto->title : $textosPiloto->title_en ?? ''}}</h1>
        <div class="row mb-4">
            <div class="col-md-6">
                {!! app()->getLocale() == 'fr' ? $textosPilto->text_1 : $textosPiloto->text_1_en ?? '' !!}
                {{--
            ...
            <div class="col-md-6">
                ...
                {!! app()->getLocale() == 'fr' ? $textosPilto->text_2 : $textosPiloto->text_2_en ?? '' !!}
