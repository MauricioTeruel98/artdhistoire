...
@section('content')
    <div class="container profile-container">
                    ...
                    <div class="tab-pane fade show active" id="account" role="tabpanel">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label
                                    for="avatar">{{ app()->getLocale() == 'fr' ? 'Changer l\'avatar' : 'Change avatar' }}</label>
                            ...
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_student" id="is_student"
                                        value="1" {{ $user->is_student ? 'checked' : '' }}>
                    ...
                    <div class="tab-pane fade" id="subscription" role="tabpanel">
                        ...
                        @else
                            <div class="text-center">
                                <p>{{ app()->getLocale() == 'fr' ? 'Vous n\'avez aucun abonnement actif.' : 'You have no active subscriptions.' }}
                                </p>
        ...
        <!-- Agregar justo antes del cierre de la etiqueta </div> del container principal -->
        <a href="{{ route('access-coupon.form') }}" class="floating-coupon-btn">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M22 12v3a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2v-3" />
                <path d="M22 4v3a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V4" />
                <line x1="12" y1="16" x2="12" y2="20" />
                <line x1="12" y1="4" x2="12" y2="14" />
            </svg>
            {{ app()->getLocale() == 'fr' ? 'Utiliser un coupon' : 'Use coupon' }}
        </a>
    </div>
    </div>
