            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills mb-3" id="profileTabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="account-tab" data-toggle="pill" href="#account" role="tab" aria-controls="account" aria-selected="true">Datos de la Cuenta</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="subscription-tab" data-toggle="pill" href="#subscription" role="tab" aria-controls="subscription" aria-selected="false">Suscripción</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="profileTabsContent">
                        ...
                        <div class="tab-pane fade" id="subscription" role="tabpanel" aria-labelledby="subscription-tab">
                            ...
                            <!-- Aquí puedes agregar más detalles de suscripción en el futuro -->
                        </div>
                    </div>
                </div>
            </div>
