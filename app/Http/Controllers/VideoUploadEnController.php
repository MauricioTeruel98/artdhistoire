...
class VideoUploadEnController extends Controller
{
    private $folderId = '1WBJ-btzSkiA0d8I8nayRwQXsnqzhF3qQ'; // ID de la carpeta en Drive para el idioma inglés
    ...
    public function setFolderPermissions()
    {
        try {
            ...
            $service->permissions->create($this->folderId, $permission, [
                'fields' => 'id',
