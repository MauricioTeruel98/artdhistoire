...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-video"></i> Éditer une vidéo de {{ $videoOnline->title }} (Français)
    </h1>
@stop
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <form class="form-edit-add" role="form" action="{{ route('videoonline.videos.update', $video->id) }}"
