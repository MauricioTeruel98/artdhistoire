                    ...
                    <form role="form" class="form-edit-add"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach ($dataTypeRows as $row)
                                ...
                                @if ($row->type == 'file' && $row->field == 'video')
                                    <div class="form-group">
                                        <label for="video">{{ $row->display_name }}</label>
                                        <input type="file" name="video" accept="video/*" class="form-control-file">
                                    </div>
                                @endif

                                <!-- Condición para ocultar el campo si es videoonline_id -->
                                @if ($row->field === 'videoonline_id')
                                    <input type="hidden" name="{{ $row->field }}" value="{{$request->videoonline_id}}">
                                @else
