                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            @foreach($actions as $action)
                                                ...
                                                @endif
                                            @endforeach
                                            <a href="/admin/archives?post_id={{ $data->id }}" class="btn btn-sm btn-info pull-right edit mx-2">
                                                View Archives (Français)
                                            </a>

                                            <a href="/admin/archives-en?post_id={{ $data->id }}" class="btn btn-sm btn-info pull-right edit mx-2">
                                                View Archives (English)
                                            </a>
