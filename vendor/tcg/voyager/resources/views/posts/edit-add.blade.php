            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> Titre (Français)
                                <span class="panel-desc"> Le titre de votre publication en français</span>
                            </h3>
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="title_fr" name="title_fr"
                                placeholder="Titre en français" value="{{ $dataTypeContent->title_fr ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ __('voyager::post.title') }} (English)
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Lien hihaho Français (Ajouter /embed après .com) 
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                    aria-hidden="true"></a>
                        ...
                        <div class="panel-body">
                            <!-- Eliminamos la funcionalidad multilingüe para este campo -->
                            <input type="text" class="form-control" id="hihaho" name="hihaho" placeholder="Lien Hihaho pour le contenu Français"
                                value="{{ $dataTypeContent->hihaho ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                Lien hihaho anglais (Ajouter /embed après .com)
                            </h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                    aria-hidden="true"></a>
                        ...
                        <div class="panel-body">
                            <!-- Eliminamos la funcionalidad multilingüe para este campo -->
                            <input type="text" class="form-control" id="hihaho_en" name="hihaho_en" placeholder="Lien Hihaho pour le contenu anglais"
                                value="{{ $dataTypeContent->hihaho_en ?? '' }}">
                        </div>
                    </div>
                    ...
                    <!-- .panel -->
                     ...
                     <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('voyager::post.excerpt') !!} (Français)</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                    aria-hidden="true"></a>
                            </div>
                        ...
                        <div class="panel-body">
                            <textarea class="form-control" name="excerpt_fr">{{ $dataTypeContent->excerpt_fr ?? '' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('voyager::post.excerpt') !!} (English)</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                    aria-hidden="true"></a>
                            </div>
                        ...
                        <div class="panel-body">
                            <div id="archives-section">
                                ...
                                <div class="archive-entry">
                                    ...
                                    <input type="file" name="archives[0][file]" class="form-control">
                                    <label>Icono</label>

                                    <input type="text" name="archives[0][type]" class="form-control"
                                        placeholder="Ej: Documento, Manual, etc.">
                                </div>
                            </div>
                            <button type="button" id="add-archive" class="btn btn-primary">Agregar otro archivo</button>
                        </div>
                    </div>

                    <script>
                        let archiveCount = 1;
                        document.getElementById('add-archive').addEventListener('click', function() {
                            const archivesSection = document.getElementById('archives-section');
                            const newArchive = `
            <div class="archive-entry">
                <label>Archivo PDF</label>
                <input type="file" name="archives[${archiveCount}][file]" class="form-control">
                <label>Icono</label>
                
                <input type="text" name="archives[${archiveCount}][type]" class="form-control" placeholder="Ej: Documento, Manual, etc.">
            </div>
        `;
                            archivesSection.insertAdjacentHTML('beforeend', newArchive);
                            archiveCount++;
                        });
                    </script>
                    ...
                    @foreach ($dataTypeContent->archives as $archive)
                        <div class="archive-entry">
                            <label>Archivo Actual: {{ $archive->route }}</label>
                            <a href="{{ Storage::url($archive->route) }}" target="_blank">Ver archivo</a>
                            <label>Icono Actual: </label>
                            <label>Tipo: {{ $archive->type }}</label>
                            <!-- Aquí puedes añadir un checkbox para eliminar el archivo -->
                            <input type="checkbox" name="delete_archives[]" value="{{ $archive->id }}"> Eliminar archivo
                        </div>
                    @endforeach --}}
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="slug_fr" name="slug_fr"
                                    placeholder="slug-fr" {!! isFieldSlugAutoGenerator($dataType, $dataTypeContent, 'slug_fr') !!}
                                    value="{{ $dataTypeContent->slug_fr ?? '' }}">
                            </div>
                            <div class="form-group">
                    ...
                    @if ($edit)
                        <div class="panel panel-bordered panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="icon wb-search"></i> Archives
                                </h3>
                                <div class="panel-actions">
                                    <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                        aria-hidden="true"></a>
                            ...
                            <div class="panel-body">
                                <a href="{{ route('voyager.archives.index', ['post_id' => $dataTypeContent->id]) }}"
        ...
        @section('submit-buttons')
            <button type="submit" class="btn btn-primary pull-right">
                @if ($edit)
                    Update
                @else
                    <i class="icon wb-plus-circle"></i> Save
                @endif
            </button>
        @stop
