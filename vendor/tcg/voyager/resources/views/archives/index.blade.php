...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-file-text"></i> Archives Français du Post : {{ $post->title }}
    </h1>
@stop
            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <form action="{{ route('voyager.archives.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <tbody id="sortable-archives">
                                @foreach ($archives as $archive)
                                    <tr data-id="{{ $archive->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('voyager.archives.edit.edit', $archive->id) }}"
                                                class="btn btn-sm btn-primary">Modifier</a>
                                            <form action="{{ route('voyager.archives.destroy.destroy', $archive->id) }}"
